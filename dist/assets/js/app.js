...
!function (a, b) {
  ...
  function c(a) {
    ...
    if (arguments.length <= 0) throw new Error("Missing arguments in extend function");var b,
      ...
      var g = arguments[c] || {};for (b in g) {
        f[b] = "object" != _typeof(f[b]) || d(f[b]) ? f[b] || g[b] : e(f[b], g[b]);
      }
    }return f;
  }function f(a) {
  ...
  }var h = { bind: !!function () {}.bind, classList: "classList" in b.documentElement, rAF: !!(a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame) };a.requestAnimationFrame = a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame, c.prototype = { constructor: c, update: function update() {
